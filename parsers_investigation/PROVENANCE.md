...
|---|---|---|---|
| `Schmid-Laws.pdf` | Schmid e Laws, COLING 2008; CC BY-NC-SA 3.0 no próprio PDF; SHA-256 `55af5b5231b49254039fc452ab6fbb53abb297564d07e439cfded4bebe2d2484` | hipótese futura de decompor etiquetas finas em atributos, usar contexto de ordem maior e estimar componentes separadamente | nenhum texto, tabela, algoritmo ou código incorporado; |
