...
[[nodiscard]] std::string_view age_name(std::uint8_t value) noexcept;
[[nodiscard]] std::string_view
lexical_frequency_name(std::uint8_t value) noexcept;
[[nodiscard]] std::string_view rule_frequency_name(std::uint8_t value) noexcept;
[[nodiscard]] std::string_view subject_name(std::uint8_t value) noexcept;
[[nodiscard]] std::string_view geography_name(std::uint8_t value) noexcept;
[[nodiscard]] std::string_view source_name(std::uint8_t value) noexcept;
[[nodiscard]] std::string_view noun_kind_name(std::uint8_t value) noexcept;
