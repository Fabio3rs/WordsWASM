#!/usr/bin/env python3
"""Validate real high-level WASM documents against the browser v6 schemas."""
...
def main() -> None:
    ...
    search_path = (root / "schemas/browser-search-v6.schema.json").resolve()
    analysis_path = (root / "schemas/browser-analysis-v6.schema.json").resolve()
    ...
    schema_paths = (
        ...
        (root / "schemas/browser-form-v6.schema.json").resolve(),
    )
    store = {
